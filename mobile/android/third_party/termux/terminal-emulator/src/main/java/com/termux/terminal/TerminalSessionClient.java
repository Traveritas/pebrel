// Modified for Pebrel in 2026: default transport readiness and input rejection callbacks.
...
public interface TerminalSessionClient {
    default void onTransportReady(TerminalSession session) { }
    default void onInputRejected(TerminalSession session) { }
